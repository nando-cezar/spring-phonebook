package br.edu.ifba.phonebook.domain.exception.handler;

import br.edu.ifba.phonebook.domain.exception.dto.ApiError;
import br.edu.ifba.phonebook.domain.exception.model.ContactNotFoundException;
import br.edu.ifba.phonebook.domain.exception.model.ContentNotAllowedException;
...
public class GlobalExceptionHandler {
    ...
    public final ResponseEntity<ApiError> handleException(Exception ex, WebRequest request) {
        ...
        if (ex instanceof ContactNotFoundException unfe) {
     ...
     */
    protected ResponseEntity<ApiError> handleMedicNotFoundException(ContactNotFoundException ex,
                                                                    HttpHeaders headers,
                                                                    HttpStatus status,
                                                                    WebRequest request) {
